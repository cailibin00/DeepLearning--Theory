...
$$L_{AT} = \sum_{k}^{N} \frac{1}{C_k H_k W_k} \| \frac{\text{Norm}(CAM_{teacher}^k)}{\|\text{Norm}(CAM_{teacher}^k)\|_2} - \frac{\text{Norm}(CAM_{student}^k)}{\|\text{Norm}(CAM_{student}^k)\|_2} \|_2^2$$
...
## AFD
<img src="../图片/AFD论文/file-20250930160432919.png">
<img src="../图片/AFD论文/file-20250930160522469.png">
...
更加严重的是，有时候还会用到插值法或者1 x 1卷积来消除两边特征图的差距，这样有损性能。
不同架构的网络没办法实现蒸馏/效果很差。
