...
## 蒸馏
<img src="../图片/Distill BERT/file-20250930161947050.png" >
### 学生模型
...
我认为，这是一种非常奇怪的初始化办法，没有说通的可能性，不过，能够学到教师模型对于输入部分输入的权重宏观分布；我认为以后的蒸馏都要向BERT的蒸馏结构靠近——减少层数，而不是改变结构，这样避免了模型输出结构不同带来的不确定性（需要再加一个适应HEAD），同时直观缩小了模型。
