...
## GPT-3
文章[GPT3文章（网页版本）](https://ar5iv.labs.arxiv.org/html/2005.14165?_immersive_translate_auto_translate=1)
### 前言
...
#### 量化数据集污染
首先，值得一提：作者同样使用**13-gram检测**的办法，将测试集的样本作为污染物，在训练集中比较寻找，并清除污染，但是由于bug，未完全过滤（训练成本太大没有重新开始）。
